...
export const ErrorCode = {
  ...
  SPACE_HAS_ACTIVE_CONTENT: "SPACE_HAS_ACTIVE_CONTENT",
  LIST_HAS_TASKS:          "LIST_HAS_TASKS",
  FOLDER_NOT_ARCHIVED:      "FOLDER_NOT_ARCHIVED",
  LIST_HAS_ACTIVE_TASKS:    "LIST_HAS_ACTIVE_TASKS",
